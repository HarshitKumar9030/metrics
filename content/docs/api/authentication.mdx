...
description: "How API keys and Clerk auth work in Harshit Metrics."
---
...
The dashboard and management APIs use [Clerk](https://clerk.com) for authentication. This provides:
